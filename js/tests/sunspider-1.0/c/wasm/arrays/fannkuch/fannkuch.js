...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'fannkuch.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'fannkuch.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'fannkuch.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "fannkuch.html.mem" : null;
