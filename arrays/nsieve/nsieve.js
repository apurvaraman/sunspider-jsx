...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'nsieve.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'nsieve.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'nsieve.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "nsieve.html.mem" : null;
